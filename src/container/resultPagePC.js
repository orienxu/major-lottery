...
class ResultPagePC extends Component {
    ...
    card2 = (img) => {
        return (
            ...
            >
                <div>
                    <img src={Res.cardBack} style={{  width: '35vmin', height: 'auto' }} className="App-logo" alt="logo" onClick={this.handleClick2} />
                </div>
                <div>
                    <img src={Res[img]} style={{ width: '35vmin', height: 'auto' }} className="App-logo" alt="logo" onClick={this.handleClick2} />
                </div>
            </ReactCardFlip>
        );
    }
    ...
    card3 = (img) => {
        return (
            ...
            >
                <div>
                    <img src={Res.cardBack} style={{ width: '35vmin', height: 'auto' }} className="App-logo" alt="logo" onClick={this.handleClick3} />
                </div>
                <div>
                    <img src={Res[img]} style={{ width: '35vmin', height: 'auto' }} className="App-logo" alt="logo" onClick={this.handleClick3} />
                </div>
            </ReactCardFlip>
        );
    }
...
export default withRouter(ResultPagePC);